...
<br><br>
-> 수능 서비스는 개인 정보를 받지 않고 방 이름과  비밀번호를 통해
   개인화를 확보하였습니다
<br><br>
...
-> 사용 대상은 학생과 광고주 입니다.
   <br>
   학생들은 킬러문제의 풀이과정을 공부할 수 있고
   복습문제를 저장할 수 있습니다.
   링크를 통해 친구간 공유가 가능합니다.
   <br>
   광고주는 회사의 문제집을 사용성에 맞게 보여줄 수 있고
   pdf를 통해 맛보기를 제공할 수 있습니다
   또한 추천영상에서 인갈 정보를 광고할 수 있습니다.
   <br><br>

**3. 어떻게 흥미를 유도할 것인가**
<br><br>
-> 사용자 인터페이스의 처음 화면, 문제집, 영상카드에 커서를 hover하면
   생동감 있게 움직입니다.
   <br><br>
